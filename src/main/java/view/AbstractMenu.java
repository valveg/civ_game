...
public class AbstractMenu {
    ...
    public AbstractMenu() {
        ...
        exploreButton.setOnMousePressed(e -> {
                ...
                Media zelda = new Media(new File("src/main/java/view/zelda.mp3").toURI().toString());
                MediaPlayer plays = new MediaPlayer(zelda);
                plays.play();


                plays.setStopTime(Duration.seconds(6));
        ...
        endTurnButton.setOnAction(event -> {
                ...
                Media end = new Media(new File("src/main/java/view/move.mp3").toURI().toString());
                MediaPlayer playa = new MediaPlayer(end);
                playa.play();
