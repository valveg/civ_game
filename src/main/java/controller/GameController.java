    ...
    public static void setLastClicked(TerrainTileFX last) {
        ...
        if (state == GameState.ATTACKING) {
            if (!attack(last)) {
                ...
                alert.setHeaderText("There was an attack error!");
                alert.setContentText("Uh oh, you cannot attack.");
                alert.showAndWait();
            }
            ...
            if (!move(last)) {
                ...
                a.setTitle("Error");
                a.setHeaderText("There was a move error!");
                a.setContentText("Uh oh, you cannot move.");
                a.showAndWait();
            } else {
                lastClicked = last;
            }
